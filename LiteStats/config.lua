...
-- Bags block
	Gold = {
		...
		anchor_frame = IsAddOnLoaded("cargBags_Pernobilis") and "cBags_Main" or "NivayacBniv_Bag", anchor_to = "right", anchor_from = "bottomright",
		x_off = 0, y_off = 6, tip_anchor = "ANCHOR_TOPRIGHT", tip_x = -3, tip_y = 7
	},
}
