...
do
	...
	getBackdrop = function(obj, isHeader)
		...
		SettingsDB.SkinFadedPanel(backdrop)
		backdrop:SetPoint("TOPLEFT", header or obj, SettingsDB.Scale(-2), SettingsDB.Scale(2))
		backdrop:SetPoint("BOTTOMRIGHT", header or obj, SettingsDB.Scale(2), SettingsDB.Scale(-2))
		...
		--backdrop:SetBackdropColor(unpack(SettingsCF["media"].overlay_color))
