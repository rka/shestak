...
----------------------------------------------------------------------------------------
if SettingsCF["misc"].raid_planner ~= true then return end
...
local createFs = function(parent, justify, fsize)
	...
	f:SetFont(SettingsCF["media"].normal_font, 12)
	if justify then
...
infotext:SetFont(SettingsCF["media"].normal_font, 12)
...
raidtext:SetFont(SettingsCF["media"].normal_font, 12)
...
SettingsDB.SkinFadedPanel(inspectButton)
...
EventFrame:SetScript("OnEvent", function(self, event, ...)
	if event == "ADDON_LOADED" then
		if arg1 == addonName then
			SettingsDB.SkinFadedPanel(buffs)
			SettingsDB.SkinFadedPanel(debuffs)
			SettingsDB.SkinFadedPanel(classes)
			SettingsDB.SkinFadedPanel(raid)
			SettingsDB.SkinFadedPanel(title)
            SettingsDB.SkinFadedPanel(info)
