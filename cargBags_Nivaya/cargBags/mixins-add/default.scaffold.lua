...
local function ItemButton_Scaffold(self)
	self:SetSize(SettingsCF["bag"].button_size, SettingsCF["bag"].button_size)
	self:SetHighlightTexture("")
	self:SetPushedTexture("")
	self:SetNormalTexture("")
	SettingsDB.CreateBlizzard(self)
	...
	self.Count:SetFont(SettingsCF["media"].pixel_font, SettingsCF["media"].pixel_font_size, SettingsCF["media"].pixel_font_style)
